...
from algorithms.double_dynamic_frame_skip_dqn import create_double_dynamic_frame_skip_dqn
...
def main(dqn_type):
    base_log_path = "/home/noamg/deeprl/logs/monitor"
    ...
    if dqn_type == "baseline":
        model = DQN("CnnPolicy", env, buffer_size=30000, learning_rate=1e-4, batch_size=32, exploration_fraction=0.3, exploration_final_eps=0.05, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
        ...
        model = create_categorical_dqn(env, n_atoms=51, v_min=-10, v_max=10, batch_size=32, exploration_final_eps=0.05, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
        ...
        model = create_noisy_dqn(env, batch_size=128, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
        ...
        model = create_noisy_categorical_dqn(env, n_atoms=51, v_min=-10, v_max=10, batch_size=32, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
        ...
        model = create_dynamic_frame_skip_dqn(env, batch_size=32, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
    ...
    elif dqn_type == "ddfdqn":
        model = create_double_dynamic_frame_skip_dqn(env, batch_size=32, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
        model_name = "ddfdqn_model"
        plot_title = "Double Dynamic Frame Skip DQN Training and Evaluation Analysis"
        plot_file_name = "ddfdqn_results_graph.png"
    # elif dqn_type == "rainbow":
    #     model = create_rainbow_dqn(env, n_atoms=51, v_min=-10, v_max=10, batch_size=32, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
    ...
    #     plot_file_name = "rainbow_dqn_results_graph.png"
        ...
        model = create_double_dqn(env, batch_size=32, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
    ...
    # elif dqn_type == "per":
    #     model = create_per_dqn(env, batch_size=32, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
    ...
    #     plot_file_name = "per_dqn_results_graph.png"
        ...
        model = create_dynamic_action_repetition_dqn(env, batch_size=32, tensorboard_log="/home/noamg/deeprl/logs/tensorboard", verbose=1)
    ...
    csv_path = f"/home/noamg/deeprl/Seaquest_RL/RL_Project/logs/{model_name}/progress.csv"
    plot_metrics(csv_path, plot_title=plot_title, plot_file_name=plot_file_name)

if __name__ == "__main__":
    print("Type of DQN to run \nbaseline, categorical, noisy, noisy_categorical, dfdqn, ddfdqn, rainbow, double, per, or dar")
